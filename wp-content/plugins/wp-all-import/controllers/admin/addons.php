...
class PMXI_Admin_Addons extends PMXI_Controller_Admin {
    ...
    public function __construct() {
        ...
        self::$premium['PMWI_Plugin'] = array(
            'title' => __("WooCommerce Addon",'wp-all-import'),
            'description' => __("Import Products from any XML or CSV to WooCommerce",'wp-all-import'),
        ...
        self::$premium['PMAI_Plugin'] = array(
            'title' => __("ACF Addon",'wp-all-import'),
            'description' => __("Import to advanced custom fields",'wp-all-import'),
            'thumbnail' => 'http://placehold.it/220x220',
        ...
        self::$premium['PMTI_Plugin'] = array(
            'title' => __("Toolset Types Addon",'wp-all-import'),
            'description' => __("Import to toolset types",'wp-all-import'),
            'thumbnail' => 'http://placehold.it/220x220',
        ...
        self::$premium['PMLI_Plugin'] = array(
            'title' => __("WPML Addon",'wp-all-import'),
            'description' => __("Import to WPML",'wp-all-import'),
            'thumbnail' => 'http://placehold.it/220x220',
        ...
        self::$premium['PMUI_Plugin'] = array(
            'title' => __("User Addon",'wp-all-import'),
            'description' => __("Import Users",'wp-all-import'),
            'thumbnail' => 'http://placehold.it/220x220',
        ...
        self::$premium['PMGI_Plugin'] = array(
            'title' => __("Gravity Forms Addon",'wp-all-import'),
            'description' => __("Import Gravity Forms Entries",'wp-all-import'),
            'thumbnail' => 'http://placehold.it/220x220',
        ...
        self::$premium['PMMI_Plugin'] = array(
            'title' => __("Meta Box Addon",'wp-all-import'),
            'description' => __("Import Meta Box Custom Fields",'wp-all-import'),
            'thumbnail' => 'http://placehold.it/220x220',
        ...
        self::$premium['PMLCA_Plugin'] = array(
            'title' => __("Link cloaking Addon",'wp-all-import'),
            'description' => __("Affiliate link cloaking",'wp-all-import'),
            'thumbnail' => 'http://placehold.it/220x220',
        ...
        self::$free['PMWI_Plugin'] = array(
            'title' => __("WooCommerce Addon - free edition",'wp-all-import'),
            'description' => __("Import Products from any XML or CSV to WooCommerce",'wp-all-import'),
            'thumbnail' => 'http://placehold.it/220x220',
        ...
        self::$free['PMWITabs_Plugin'] = array(
            'title' => __("WooCommerce Tabs Addon",'wp-all-import'),
            'description' => __("Import data to WooCommerce tabs",'wp-all-import'),
            'thumbnail' => 'http://placehold.it/220x220',
