...
class PhotonicPhotoSwipe5 extends _Lightbox.Lightbox {
  ...
  initialize(selector) {
    ...
    document.querySelectorAll('.photonic-photoswipe-solo').forEach(function (current, idx) {
      ...
      lightbox.on('beforeOpen', function (e) {
        var {
          pswp
        } = lightbox;
    ...
    document.querySelectorAll('.photoswipe-video, .photoswipe-html5-video').forEach(function (current, idx) {
      var href = current.href;
