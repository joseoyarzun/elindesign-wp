 ...
 */
abstract class Core {
	public $library, $api_key, $api_secret, $provider, $user_agent, $nonce, $oauth_timestamp, $signature_parameters, $link_lightbox_title,
	...
	protected function __construct() {
		global $photonic_enable_popup, $photonic_thumbnail_style, $photonic_slideshow_interval;
		$this->library = Photonic::$library;
		...
		$this->bypass_popup                      = empty($photonic_enable_popup) || 'off' === $photonic_enable_popup || 'hide' === $photonic_enable_popup;
	...
	public function get_header_display($args) {
	...
	public function get_hidden_headers($arg_headers, $setting_headers) {
		return [
	 ...
	 * @return string
	 */
	public function wp_error_message($response, $server_msg = true) {
		$ret = '';
		if ($server_msg) {
