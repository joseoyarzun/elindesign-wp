...
class Zenfolio extends Core implements Level_One_Module, Level_Two_Module {
	...
	public function build_level_2_objects($response, array $short_code, $filter_list = [], &$options = []) {
	 ...
	 * @return array
	 */
	private function process_set($response, $options, &$short_code, Pagination &$pagination) {
		$components = [];
	 ...
	 * @return array
	 */
	public function prepare_request($method, $params, $keyring = null) {
		$request           = [];
