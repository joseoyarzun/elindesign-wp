...
*	<a href='http://photoswipe.com/'>PhotoSwipe v5</a>
...
For the non-GPL alternatives like <a href='http://fancyapps.com/fancybox/'>Fancybox2</a> and the obsolete libraries, Photonic has code to work with them, but you have to install the scripts yourself or rely on them from your theme or another plugin.
...
In mid-September 2022 Meta / Facebook / Instagram changed its rules to disallow individual developers (i.e. developers not operating as a business) from meaningfully using its API. As a result, Photonic no longer works for Instagram photos. The code is still in place though, and works for authorized users, as can be seen <a href='https://aquoid.com/plugins/photonic/instagram/'>here</a>.
...
*	Changed: Version number in readme.txt to be consistent.
*	Changed: Plugin file header to include PHP version requirements. Previously only included in readme.txt.

= 3.00 =

*	Changed: Adopted backwards-incompatible PHP 7.0 syntax - null coalescing operator and function return types.
*	Changed: Moved some of the code to separate files to keep things more readable.
*	Added: Support for YouTube timestamps in lightboxes that allow such functionality.
*	Removed: Instagram options.
*	Removed: Support for IE11 and older browsers.
*	Fixed: Typo "grove" has been corrected to "groove".
*	Fixed: Option <code>type='wp'</code> was not working for slideshow layouts.
*	Fixed: If there were slideshows from 2 or more platforms, the first gallery of the second platform was not showing up.
*	Fixed: Widgets, Elementor and Beaver content was not showing in JS load mode.
*	Fixed: WP 6.2 broke the Flickr functionality to retrieve collections in parallel.
